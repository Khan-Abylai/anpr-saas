...
class TritonPythonModel:
    ...
    def initialize(self, args):
        ...
        self.converter = StrLabelConverter(string.digits + string.ascii_lowercase)

        self.regions = ["dubai", "abu-dhabi", "sharjah", "ajman", "ras-al-khaimah", "fujairah", "alquwain", "bahrein", "oman", "saudi", "quatar", "kuwait", "others"]
